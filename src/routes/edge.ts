...
async function upsertTransaction(restaurantId: string, txnId: string, data: any): Promise<SyncItemResult> {
  ...
  const txnData: any = {
    ...
    upiTipAmount: new Prisma.Decimal(upiTipAmount ?? (String(paymentMethod).toUpperCase() === "UPI" ? (tipAmount || 0) : 0)),
    cashAmount: new Prisma.Decimal(cashAmount || 0),
    cardAmount: new Prisma.Decimal(cardAmount || 0),
    upiAmount: new Prisma.Decimal(upiAmount || 0),
    txnDate,
...
async function upsertWalkinTransaction(restaurantId: string, txnId: string, data: any): Promise<SyncItemResult> {
  ...
  await prisma.transaction.create({
    data: {
      ...
      cashTipAmount: new Prisma.Decimal(cashTipAmount ?? (String(method).toUpperCase() === "CASH" ? (tipAmount || 0) : 0)),
      cardTipAmount: new Prisma.Decimal(cardTipAmount ?? (String(method).toUpperCase() === "CARD" ? (tipAmount || 0) : 0)),
      upiTipAmount: new Prisma.Decimal(upiTipAmount ?? (String(method).toUpperCase() === "UPI" ? (tipAmount || 0) : 0)),
